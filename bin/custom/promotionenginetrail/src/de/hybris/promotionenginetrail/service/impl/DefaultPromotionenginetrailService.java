...
public class DefaultPromotionenginetrailService implements PromotionenginetrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPromotionenginetrailService.class);
	...
	{
		return DefaultPromotionenginetrailService.class.getResourceAsStream("/promotionenginetrail/sap-hybris-platform.png");
	}
