...
/**
 * This is the extension manager of the Promotionenginetrail extension.
 */
public class PromotionenginetrailManager extends GeneratedPromotionenginetrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(PromotionenginetrailManager.class);
	 ...
	 */
	public static PromotionenginetrailManager getInstance()
	{
		return (PromotionenginetrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(PromotionenginetrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PromotionenginetrailManager() // NOPMD 
	{
		LOG.debug("constructor of PromotionenginetrailManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of PromotionenginetrailManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of PromotionenginetrailManager called, current tenant: {}", getTenant().getTenantID());
	}
